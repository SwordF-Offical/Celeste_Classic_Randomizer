...
function _draw()
 ...
 -- randomizer screen
 if rando_screen>0 then
 	local pos=split("144,153,162,171,189,198,214,234")
 	...
 	if not start_game then
	 	...
	 	if btnp(🅾️) then
	 		if (arrow!=8) sfx"7"
	 		if (arrow==1) player_spawn=change_settings(player_spawn)
	 		if (arrow==2) strawberry=change_settings(strawberry)
	 		if (arrow==3) terrain=change_settings(terrain)
	 		if (arrow==4) background=change_settings(background)
	 		if (arrow==5) add_memorial=change_settings(add_memorial)
	 		if (arrow==6) add_chest=change_settings(add_chest)
 	...
 	swag_text("player spawn - "..player_spawn,11,145)
 	swag_text("berry spawn - "..strawberry,11,154)
 	swag_text("terrain - "..terrain,11,163)
		swag_text("background - "..background,11,172)
		
		swag_text("add memorial - "..bool(add_memorial),11,190)
		swag_text("add big chest - "..bool(add_chest),11,199)
		
		swag_text("player graphic - "..graphic_names[graphic],11,215)
		spr(122,10,222)
		spr(graphic_ref[graphic],10,222)
...
graphic_ref={1,128,135,167,144,151,160}
hair_ref={
	-- madeline
	{nodes=5,color={12,8,11,7}},
	
	-- lena
	{nodes=0,color={12,1,11,7}},
	
	-- theo
	{nodes=0,color={12,2,11,7}},
	
	-- plumber
	{nodes=0,color={12,12,3,11}},
	
	-- vaporeon
	{nodes=0,color={9,8,14,14}},
	
	-- axew
	{nodes=0,color={12,13,15,15}},
	
	-- puro
	{nodes=5,color={12,1,6,7}},
...
function generate_tile_pool()
	...
	if (add_memorial) add(pool,86)
	if (add_chest) add(pool,96)
...
function generate_room(x,y)
	...
	-- generate map
	for _y=0,15 do
		if _y>0 or terrain=="random" then
		for _x=0,15 do
			-- grab cords
			local x_cord=_x+x*16
			local y_cord=_y+y*16
			...
			if (table_has(berry_tiles,_t) and strawberry=="default") can_write=false
			if (table_has(terrain_tiles,_t) and terrain=="default") can_write=false
...
function generate_map()
	...
	for j=0,1 do
		for i=0,7 do
			if ( not table_has(keep_rooms,n) ) generate_room(i,j)
			n+=1
		end
	end
...
top_map=[[

]]
bottom_map=[[

]]
...

...
__gff__

...

__sfx__
