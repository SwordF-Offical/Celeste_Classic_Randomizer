 ...
 if rando_screen>0 and arrow!=0 then
 	...
 	if not start_game then
	 	...
	 	if btnp(🅾️) then
	 		if (arrow!=7) sfx"7"
	 		if arrow==1 then
	 			seed+=exponent(10,4-seed_arrow)
	 			if (seed>9999) seed=0
	 		end
	 		if (arrow==2) player_spawn=change_settings(player_spawn)
	 		if (arrow==3) strawberry=change_settings(strawberry)
	 		if (arrow==4) terrain=change_settings(terrain)
	 		if (arrow==5) background=change_settings(background)	 		
	 		if arrow==6 then
	 			graphic+=1
 	...
 	swag_text("seed - "..seed,11,145)
 	for i=1,4 do
 		if (seed<exponent(10,i-1)) swag_text(0,35+i*4,145)
 		if arrow==1 and seed_arrow==i then
 			spr(123,34+i*4,145)
 		end
 	end
 	if arrow==1 then
...

